...
public:
    ...
    //void Output_Landmark(string, struct_Voxel*, int);
    //void Output_Picture_X(string, struct_Voxel*, int);
    //void Output_Picture_Y(string, struct_Voxel*, int);
    //void Output_Picture_Z(string, struct_Voxel*, int);
